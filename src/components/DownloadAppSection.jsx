export default function DownloadAppSection() {
  return (
    <section className="py-20 px-6 max-[550px]:px-4 bg-[#f4f7f9] overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        <div className="w-full md:w-1/2 space-y-6 text-center md:text-left flex flex-col items-center md:items-start">
          <h2 className="text-4xl max-[550px]:text-3xl md:text-5xl font-black text-[#0d1b33]">Հավելված My Team</h2>
          <p className="text-gray-700 text-lg max-[550px]:text-base leading-relaxed">Ներբեռնե՛ք My Team-ը iOS և Android համակարգերի համար։ Կատարե՛ք վճարումներ, ստացե՛ք բոնուսներ և օգտվե՛ք այլ հնարավորություններից։</p>
        ...
        <div className="w-full md:w-1/2 flex flex-col sm:flex-row items-center justify-center gap-6">
          ...
          <img src="https://www.telecomarmenia.am/images/advanced_slider/2/17400318089669.png" alt="My Team App" className="h-[300px] sm:h-[400px] object-contain drop-shadow-2xl" />
        </div>
      </div>
    </section>
  );
