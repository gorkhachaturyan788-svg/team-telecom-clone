...
const slides = [
  {
    ...
    subtitle: "", // Դատարկ, որպեսզի տեղ չզբաղեցնի
    btn: "Ավելին"
  },
  {
...
export default function HeroSlider() {
  ...
  return (
    <div className="relative w-full h-[300px] md:h-[450px] lg:h-[500px] overflow-hidden bg-black mt-8">
      ...
      <button
        ...
        className="absolute left-4 top-1/2 -translate-y-1/2 z-20 bg-black/30 text-white w-10 h-10 rounded-full hover:bg-black/50 transition"
      >❮</button>

      <button
        onClick={() => setCurrent(prev => (prev === slides.length - 1 ? 0 : prev + 1))}
        className="absolute right-4 top-1/2 -translate-y-1/2 z-20 bg-black/30 text-white w-10 h-10 rounded-full hover:bg-black/50 transition"
      >❯</button>
