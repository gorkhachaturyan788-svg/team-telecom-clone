...
export default function Car1() {
  ...
  return (
    <div className="w-full font-sans bg-[#f7f5f0] pb-10">
      ...
      {/* Վերին գլխավոր հատվածը՝ նոր նկարով */}
      <div className="relative w-full h-[320px] md:h-[380px] lg:h-[420px] overflow-hidden bg-white">
        <div 
          className="absolute inset-0 bg-cover bg-center"
          style={{ 
            backgroundImage: `url('https://www.telecomarmenia.am/images/menu/1/17857571349765.png')` 
          }}
        ></div>
      </div>
