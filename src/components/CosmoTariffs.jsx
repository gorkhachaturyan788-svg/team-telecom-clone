...
export default function CosmoTariffs() {
  ...
  // Անիմացիայի համար ընդհանուր className-ները
  const cardHoverStyle = 
    "bg-white rounded-2xl p-6 lg:p-8 flex flex-col justify-between text-center relative " +
    "transform transition-all duration-300 ease-out " + // Սահուն փոխանցում
    "hover:-translate-y-3 hover:scale-[1.02] hover:shadow-2xl hover:z-10 shadow-lg border border-transparent hover:border-gray-200 cursor-pointer";
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 xl:gap-8 items-stretch pt-4">
          ...
          <div className={cardHoverStyle}>
            ...
            <button className="w-full mt-8 bg-[#e85050] hover:bg-[#d43f3f] text-white font-bold py-3.5 rounded-full text-base transition-all duration-200 shadow-md hover:shadow-lg">Միանալ</button>
          </div>

          {/* CARD 2: ԿՈՍՄՈ 4 (25%) */}
          <div className={cardHoverStyle}>
            <div className="absolute -top-4 -right-2 bg-[#e85050] text-white font-extrabold text-lg px-3 py-1 rounded-full shadow-lg transform rotate-12">
              25%
            </div>
            <div>
