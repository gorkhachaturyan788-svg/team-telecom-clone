...
export default function FixedPhoneArajin() {
  const navItems = [
    { 
      title: "TeamTV", 
    ...
    <div className="w-full font-sans bg-[#f7f5f0] pb-10">
      ...
      <div className="relative w-full h-[320px] md:h-[380px] lg:h-[420px] overflow-hidden bg-[#e8e2d5]">
        <div 
          ...
          style={{ 
            backgroundImage: `url('https://www.telecomarmenia.am/images/menu/1/16509749702952.png')` 
          }}
        >
