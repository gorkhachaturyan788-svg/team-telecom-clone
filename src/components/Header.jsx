  ...
  return (
    <header className="w-full font-sans">
      ...
      <div className="bg-white h-auto lg:h-[80px] flex flex-col lg:flex-row items-center justify-between px-6 sm:px-10 lg:px-[10%] border-b border-gray-200 py-4 lg:py-0 gap-4 lg:gap-0">
        ...
        <nav className="flex flex-wrap items-center justify-center lg:h-full gap-2 lg:gap-0">
          <Link to="/tariffs" className="px-3 lg:px-6 text-[#444] text-[14px] hover:text-[#003853]">Սակագներ</Link>
          <Link to="/internet" className="px-3 lg:px-6 text-[#444] text-[14px] hover:text-[#003853]">Ինտերնետ</Link>
          <Link to="/services" className="px-3 lg:px-6 text-[#444] text-[14px] hover:text-[#003853]">Ծառայություններ</Link>
          <Link to="/roaming" className="px-3 lg:px-6 text-[#444] text-[14px] hover:text-[#003853]">Ռոումինգ և Միջազգային կապ</Link>
          <Link to="/business-solutions" className="px-3 lg:px-6 text-[#444] text-[14px] hover:text-[#003853]">Բիզնես լուծումներ</Link>
          <Link to="/support" className="px-3 lg:px-6 text-[#444] text-[14px] hover:text-[#003853]">Օգնություն</Link>
        </nav>
