...
const mobileTariffs = {
  prepaid: {
    ...
    "Team": [
      { id: 7, internet: "10 ԳԲ", minutes: "200 րոպե", channels: "20 ալիք", price: "2,900", path: "/mobile-tariffs/prepaid-team-2900" },
    ]
  },
  postpaid: {
    "Be Free Unlimit": [
    ...
    "Team": [
      { id: 8, internet: "15 ԳԲ", minutes: "400 րոպե", channels: "25 ալիք", price: "4,500", path: "/mobile-tariffs/team-4500" },
    ]
  }
};
...
export default function MobileList() {
  ...
  const [selectedCategory, setSelectedCategory] = useState('Be Free Unlimit');

  const categories = Object.keys(mobileTariffs[paymentType] || {});
  
  // Ensure selectedCategory exists in the current paymentType categories, otherwise default to the first one
  const activeCategory = categories.includes(selectedCategory) ? selectedCategory : categories[0];
  const currentCards = mobileTariffs[paymentType][activeCategory] || [];
