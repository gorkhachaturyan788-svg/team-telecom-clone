...
export default function ZvartjancArajin() {
  const navItems = [
    { 
      title: "TeamTV", 
  ...
  return (
    <div className="w-full font-sans bg-[#f7f5f0] pb-10">
      ...
      <div className="relative w-full h-[320px] md:h-[380px] lg:h-[420px] overflow-hidden bg-[#f3efe6]">
        <div 
          className="absolute inset-0 bg-cover bg-center"
          style={{ 
            backgroundImage: `url('https://www.telecomarmenia.am/images/menu/1/17392713413788.png')` 
          }}
        >
