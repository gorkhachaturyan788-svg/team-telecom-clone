...
export default function Kompi1() {
  ...
  return (
    <div className="w-full font-sans bg-[#f7f5f0] pb-10">
      ...
      {/* Վերին գլխավոր հատվածը՝ նկարով և բեժ ֆոնով */}
      <div className="relative w-full h-[320px] md:h-[380px] lg:h-[420px] overflow-hidden bg-[#e8e2d5]">
        <div 
          className="absolute inset-0 bg-cover bg-center"
          style={{ 
            backgroundImage: `url('https://www.telecomarmenia.am/images/menu/1/16509764002637.png')` 
          }}
        >
