...
export default function SecurityArajin() {
  const navItems = [
    { 
      title: "TeamTV", 
  ...
  return (
    <div className="w-full font-sans bg-[#f7f5f0] pb-10">
      ...
      {/* Վերին գլխավոր հատվածը՝ նկարով և կապույտ ֆոնով */}
      <div className="relative w-full h-[320px] md:h-[380px] lg:h-[420px] overflow-hidden bg-[#3db5be]">
        <div 
          className="absolute inset-0 bg-cover bg-center"
          style={{ 
            backgroundImage: `url('https://www.telecomarmenia.am/images/menu/1/17392720786572.png')` 
          }}
        >
